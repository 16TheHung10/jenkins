...
export default function ModelExportDataMultipleFix({ ...props }) {
  ...
  const onSearch = async () => {
    ...
    if (props?.isShowStore == undefined || props?.isShowStore == true) {
  ...
  return (
    <div>
      ...
      >
        ...
        <Row gutter={[16, 16]}>
          {(props?.isShowStore == undefined || props?.isShowStore == true) && (
            <Col xl={24}>
              <ModelGroupStore
