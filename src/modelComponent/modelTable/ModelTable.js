...
const ModelTable = ({ columns, data, footer, initialPage = 1, updateInitialPage, initialItemsPerPage = 100, totalItems, classNameTr, buttonFilter, isCrollTop, isLoading, showPage, styleFooter, ...props }) => {
    ...
    const renderFooter = () => {
        ...
        return (
            <tfoot>
                <tr style={{ ...styleFooter }}>
                    {columns?.map((column, colIndex) => (
                        // !column.notShow && (
                        <Fragment key={colIndex}>
                            {column.child ? (
                                column.child?.map((child, childIndex) => (
                                    <td key={`${colIndex}-${childIndex}`} className={column.notShow == true ? 'd-none' : 'd-table-cell'} style={{ ...column.styleBody }}>
                                ...
                                <td className={column.notShow == true ? 'd-none' : 'd-table-cell'} style={{ ...column.styleBody }}>
    ...
    return (
        <div style={{ ...props?.style }}>
            <>
                ...
                {data?.length > 0 && (showPage == undefined || showPage == true) ? <>
            ...
            <div ref={tableRef} style={{ maxHeight: height, overflow: 'auto', maxWidth: '100%', clear: 'both', ...props.style }} className='pos-relative'>
