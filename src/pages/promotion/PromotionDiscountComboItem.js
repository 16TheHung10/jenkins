...
import SearchComp from "components/mainContent/promotion/searchPromotionDiscountComboItem";
import Action from "components/mainContent/Action";
import AccountState from "helpers/AccountState";

export default class PromotionDiscountComboItem extends CustomAuthorizePage {
  constructor(props) {
    super(props);
