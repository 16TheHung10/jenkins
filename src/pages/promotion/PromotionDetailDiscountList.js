...
import SearchDetail from "components/mainContent/promotion/searchDetailDiscountList";

export default class PromotionDetailDiscountList extends CustomAuthorizePage {
  constructor(props) {
    super(props);
