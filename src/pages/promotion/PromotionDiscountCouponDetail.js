...
import SearchDetail from 'components/mainContent/promotion/searchPromotionDiscountCouponDetail';
import PromotionModel from 'models/PromotionModel';
import CustomAuthorizePage from 'pages/CustomAuthorizePage';
import React from 'react';
import { withRouter } from 'react-router-dom';

class PromotionDiscountCouponDetail extends CustomAuthorizePage {
  constructor(props) {
    super(props);
  ...
  renderAction() {
    ...
    return <Action leftInfo={actionLeftInfo} rightInfo={[]} ref={this.actionRef} />;
  }
...
export default withRouter(PromotionDiscountCouponDetail);
