...
import OpReportComp from "components/mainContent/reporting/mdReport/search/SalesopSaleByCategoryMD";
import Action from "components/mainContent/Action";

export default class PageOpSaleByCategoryMD extends CustomAuthorizePage {
  constructor(props) {
    super(props);
    this.state = {};
