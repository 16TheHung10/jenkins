...
import OpReportComp from "components/mainContent/reporting/mdReport/search/SearchDetailMonthMD";
import Action from "components/mainContent/Action";

export default class PageOpDetailMonthMD extends CustomAuthorizePage {
  constructor(props) {
    super(props);
    this.state = {};
