...
import OpReportComp from "components/mainContent/reporting/mdReport/search/SalesopPaymentByStoreMD";
import Action from "components/mainContent/Action";

export default class PageOpPaymentByStoreMD extends CustomAuthorizePage {
  constructor(props) {
    super(props);
    this.state = {};
