      ...
      <>
        <Row gutter={30}>
          ...
          <div className="card-container" style={{ width: '100%' }}>
            <Tabs defaultActiveKey="1" items={tabList} type="card" onChange={handleClickChangeTab} />
          </div>
          {/* </Col> */}
        </Row>
      </>
...
class PageOpSaleDetailMDCC extends CustomAuthorizePage {
  constructor(props) {
    super(props);
    this.state = {};
...
export default PageOpSaleDetailMD;
