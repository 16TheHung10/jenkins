...
import ImportItemOrderForm from 'pages/itemMaster/v2/import/order/form/ImportItemOrderForm';
...
const ItemMasterV2ImportOrder = () => {
  ...
  const handleImport = async (value) => {
    ...
    const res = await ItemsMasterApi.changeStoreItemOrder(payload);
    if (res.status) {
            ...
            <MainTable
              ...
              columns={[
                ...
                },
                {
                  ...
                  dataIndex: 'LockWH',
                  key: 'LockWH',
                  render: (text, record) => (text === true ? 'True' : text === false ? 'False' : 'Invalid value'),
                  onCell: (record) => {
                    return {
                      style: {
                        color: record.isValidLockWH ? 'black' : 'red',
                      },
                    };
                  },
                },
...
export default ItemMasterV2ImportOrder;
