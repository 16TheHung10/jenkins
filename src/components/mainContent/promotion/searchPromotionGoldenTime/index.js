...
import ListSearch from "components/mainContent/promotion/listSearchPromotionGoldenTime";
...
export default class SearchPromotionGoldenTime extends BaseComponent {
  constructor(props) {
    super(props);
