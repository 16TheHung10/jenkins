...
import ListSearch from "components/mainContent/promotion/listPromotionDiscountComboItem";
...
export default class SearchPromotionDiscountComboItem extends BaseComponent {
  constructor(props) {
    super(props);
