                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        this.handleChangeField(
                          e,
                          this.props.updateDiscountBill(e.target.value),
                        )
                      }
                      className="form-control"
                      disabled={this.isCreate ? false : true}
                          ...
                          <div className="form-group">
                            <Select
                              ...
                              value={partnersOption.filter(
                                (el) =>
                                  el.value ===
                                  fields.partnerList[i]["codeName"],
                              )}
                              onChange={(e) =>
                                this.hanldeChangeInputSelect(e, i, "codeName")
                              }
                        ...
                        <div className="col-md-4">
                          <div className="form-group">
                            {fields.partnerList.length !== 1 && (
                              <button
                                type="button"
                                onClick={() => this.hanldeRemoveInput(i)}
