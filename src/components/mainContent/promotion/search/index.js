...
import ListSearch from "components/mainContent/promotion/listSearch";
...
export default class Search extends BaseComponent {
  ...
  handleApprove = () => {
    ...
    //             this.listSearchRef.current.handleLoadResult();
    //         } else {
  ...
  handleLoadResult = () => {
    ...
    model.getListPromotion(params).then((res) => {
      if (res.status && res.data.proList) {
        this.itemCount = res.data.total;
        this.items = res.data.proList;
      }
