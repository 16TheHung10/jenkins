...
import ListSearch from "components/mainContent/promotion/listSearchDiscountItem";
...
export default class Search extends BaseComponent {
  ...
  handleLoadResult = () => {
    ...
    let page = "/promotion/discountitem/search";

    let params = {
      name: fields.promotionCode,
      startDate:
        fields.startDate !== ""
          ? DateHelper.displayDateFormat(fields.startDate, "YYYY-MM-DD")
          : "",
      endDate:
        fields.endDate !== ""
          ? DateHelper.displayDateFormat(fields.endDate, "YYYY-MM-DD")
          : "",
      pageNumber: fields.page,
      status:
        fields.orderStatus !== ""
          ? fields.orderStatus === 2
            ? 0
            : fields.orderStatus
          : "",
              ...
              <Col>
                <div className="flex items-center gap-10">
                  ...
                  {this.items && this.items.length > 0 ? (
                    <ExportPromotionData
                      promotionType="discountitem"
                      params={this.fieldSelected}
                    />
                  ) : null}
                </div>
              </Col>
