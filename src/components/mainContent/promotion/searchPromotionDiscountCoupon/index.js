...
import ListSearch from 'components/mainContent/promotion/listSearchPromotionDiscountCoupon';
...
export default class SearchPromotionDiscountCoupon extends BaseComponent {
  constructor(props) {
    super(props);
  ...
  handleLoadResult = () => {
    ...
    let page = '/promotion/coupon/search';
      ...
      <div className="form-filter ">
        <Row>
          <Col xl={24}>
            ...
            <Row className="mt-10">
              <Col span={24} className="flex gap-10">
                <button type="button" className="btn btn-success h-30" onClick={this.handleSearch}>
                  Search
                </button>
                {this.items && this.items.length > 0 ? (
                  <ExportPromotionData promotionType="coupon" params={fields} />
                ) : null}
              </Col>
            </Row>
          </Col>
