...
import ExportPromotionData from 'components/mainContent/promotion/exportExcel/ExportPromotionData';
import React from 'react';
import BaseComponent from 'components/BaseComponent';
import { DateHelper, PageHelper, StringHelper } from 'helpers';
import ListPromotionMixAndMatch from 'components/mainContent/promotion/listPromotionMixAndMatch';
...
export default class SearchPromotionMixAndMatch extends BaseComponent {
  constructor(props) {
    super(props);
  ...
  handleLoadResult = () => {
    ...
    let page = '/promotion/combo/search';
              ...
              <Col xl={6}>
                ...
                <label htmlFor="orderStatus" className="w100pc">
                  ...
                  <SelectBox
                    ...
                    defaultValue={fields.orderStatus}
                    isMode={''}
                  />
                </label>
                {/* </div> */}
              ...
              <Col>
                <div className="flex items-center gap-10">
                  ...
                  {this.items && this.items.length > 0 ? (
                    <ExportPromotionData promotionType="combo" params={this.fieldSelected} />
                  ) : null}
                </div>
              </Col>
            </Row>
