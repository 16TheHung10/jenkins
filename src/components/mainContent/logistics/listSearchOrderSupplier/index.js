...
export default class ListSearchOrderSupplier extends BaseComponent {
  constructor(props) {
    super(props);
  ...
  handleToDetail = (codeId) => {
    this.targetLink("/logistics-ordersupplier/" + codeId);
  };
  ...
  renderComp = () => {
    ...
    return (
      <section id={this.idComponent}>
        <div className="section-block app_container">
          <div
            className="wrap-table htable"
            style={{ maxHeight: "calc(100vh - 394px)" }}
          >
            <table
