...
import ListDetail from "components/mainContent/logistics/listStoreOrderDetail";

// import SearchItems from 'components/mainContent/internalOrder/items/searchItems';
// import FilterItems from 'components/mainContent/internalOrder/items/filterItems';

class SearchStoreOrderDetail extends BaseComponent {
  constructor(props) {
    super(props);
    ...
    if (this.poCode !== "") {
      ...
      await model.getListDetail(this.poCode).then((res) => {
        if (res.status && res.data && res.data.items) {
          ...
          // this.targetLink('/logistics-storeorder');
      ...
      <section className="wrap-section">
        <div className="row header-detail">
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <button
              onClick={() => super.back("/logistics-storeorder")}
              type="button"
...
export default SearchStoreOrderDetail;
