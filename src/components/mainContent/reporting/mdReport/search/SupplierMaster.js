...
export default function SupplierMaster({ ...props }) {
  ...
  const handleFilter = (list) => {
    ...
    dataFilter =
      orderDay?.length > 0 && orderDay !== ''
        ? dataFilter.filter((el) => orderDay?.some((element) => el.orderDay.split('-').includes(element)))
        : dataFilter;
    ...
    dataFilter =
      email !== ''
        ? email === 'hasEmail'
          ? dataFilter.filter((el) => el.email !== '')
          : dataFilter.filter((el) => el.email === '')
        : dataFilter;
    dataFilter =
      phone !== ''
        ? phone === 'hasPhone'
          ? dataFilter.filter((el) => el.phone !== '')
          : dataFilter.filter((el) => el.phone === '')
        : dataFilter;
    dataFilter =
      tradingName !== ''
        ? tradingName === 'hasTranding'
          ? dataFilter.filter((el) => el.tradingName !== '')
          : dataFilter.filter((el) => el.tradingName === '')
        : dataFilter;
    dataFilter =
      taxCode !== ''
        ? taxCode === 'hasTaxCode'
          ? dataFilter.filter((el) => el.taxCode !== '')
          : dataFilter.filter((el) => el.taxCode === '')
        : dataFilter;
                    ...
                    <Row gutter={16}>
                      ...
                      <Col xl={4}>
                        <label htmlFor="internalCode" className="w100pc">
                          Internal code:
                          <SelectboxAndCheckbox
                            data={internalCodeOpt}
                            funcCallback={setInternalCode}
                            keyField={'internalCode'}
                            defaultValue={''}
                            isMode={''}
                          />
                        </label>
                      ...
                      <Col xl={4}>
                        <label htmlFor="orderScheduled" className="w100pc">
                          ...
                          <SelectboxAndCheckbox
                            data={optTruFalse}
                            funcCallback={setOrderScheduled}
                            keyField={'orderScheduled'}
                            defaultValue={''}
                            isMode={''}
                          />
                        </label>
                      ...
                      <Col xl={5}>
                        <label htmlFor="tradingName" className="w100pc">
                          ...
                          <SelectboxAndCheckbox
                            data={tradingOpt}
                            funcCallback={setTradingName}
                            keyField={'tradingName'}
                            defaultValue={''}
                            isMode={''}
                          />
                        </label>
                      ...
                      <Col xl={3}>
                        ...
                        <Button type="button" onClick={() => handleExport(dataTable)} className="btn btn-danger h-30">
                          Export
                        </Button>
                      </Col>
                    </Row>
                    ...
                    <table className="table-hover d-inline-block" style={{ width: 'auto', overflow: 'auto' }}>
                      <thead>
                        <tr>
                          ...
                          <th className="fs-10 pd-5 bd-none rule-number">D/Store</th>
                          <th className="fs-10 pd-5 bd-none rule-number">D/WH</th>
                        </tr>
                        <tr></tr>
                      </thead>
                      <tbody>
