...
import TableSumByPayment from 'components/mainContent/reporting/mdReport/table/TableSumByPaymentMD';
...
export default class SalesopSummaryByPaymentMD extends BaseComponent {
  constructor(props) {
    super(props);
                      ...
                      <Col xl={8}>
                        ...
                        <Space size={'small'}>
                          ...
                          <button
                            ...
                            onClick={() => handleExportAutoField(this.itemsSumByPayment, 'summaryByPaymentExport')}
                          >
                            Export
                          </button>
                        </Space>
