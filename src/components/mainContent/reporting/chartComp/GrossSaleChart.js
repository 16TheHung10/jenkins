...
export default class GrossSaleChart extends BaseComponent {
  constructor(props) {
    super(props);
    ...
    if (data) {
      ...
      this.dataChart = newdata
        ...
        .map((item) => {
          ...
          return {
            totalGrossSales: item.totalSaleGrossSales,
            monthKey: month,
          };
        });
    }
            ...
            {this.dataChart.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={250}>
                <AreaChart data={this.dataChart} margin={{ top: 10, right: 20, left: 20, bottom: 10 }}>
                  ...
                  <YAxis yAxisId="left" fontSize={10} tickFormatter={(value) => StringHelper.formatValue(value)} />
                  <YAxis
                    yAxisId="right"
                    orientation="right"
                    fontSize={10}
