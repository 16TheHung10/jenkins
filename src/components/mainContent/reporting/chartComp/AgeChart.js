...
export default class AgeChart extends BaseComponent {
  constructor(props) {
    super(props);
  ...
  formatData = (year, data) => {
    if (data) {
      ...
      this.dataChart = newdata
        .sort(
          (a, b) =>
            a.monthKey.toString().slice(-2) - b.monthKey.toString().slice(-2),
        )
        .map((item) => {
          ...
          return {
            ...
            // totalNewMemberPartner: item.totalNewMemberPartner,
            monthKey: month,
          };
        });
    }
            ...
            {this.dataChart.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={250}>
                ...
                >
                  ...
                  {/* <Area yAxisId="left" type="monotone" dataKey="totalNewMember" stroke="#8884d8" fill="#8884d8" /> */}
                  {/* <Area yAxisId="right" type="monotone" dataKey="totalItemQty" stroke="#ffc658" fill="#ffc658" />
							<Area yAxisId="right" type="monotone" dataKey="totalInvoiceQty" stroke="#82ca9d" fill="#82ca9d" /> */}
                  <Area
                    yAxisId="left"
                    type="monotone"
                    ...
                    fill="#82ca9d"
                  />
                  {/* <Area yAxisId="left" type="monotone" name="Total new member partner" dataKey="totalNewMemberPartner" stroke="#FFA500" fill="#FFA500" /> */}
