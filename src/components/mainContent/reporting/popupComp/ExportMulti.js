...
export default class ExportMulti extends BaseComponent {
  constructor(props) {
    super(props);
    ...
    this.isStore = this.props.isStore || false;
  ...
  handleExport = () => {
    ...
    if (this.isStore) {
      this.fieldSelected.storeCodeDetailExport =
        this.storeShowExport[1][0].value;
    }
    ...
    let params = {
      type: this.type,
      method: "email",
      start: this.fieldSelected.startExport
        ? DateHelper.displayDateFormatMinus(this.fieldSelected.startExport)
        : "",
      date: this.fieldSelected.dateExport
        ? DateHelper.displayDateFormatMinus(this.fieldSelected.dateExport)
        : "",
      storeCode: store,
    };
    ...
    model.exportAnalyticreport(params).then((res) => {
      if (res.status && res.data) {
        ...
        this.showAlert(
          "File sent successfully, please check your mail " +
            ml +
            " in 15 minutes",
          "success",
          false,
            ...
            <div className="form-group">
              ...
              <Select
                ...
                value={groupStore.filter(
                  (option) =>
                    option.value === this.fieldSelected.storeCodeDetailExport,
                )}
                options={groupStore}
                onChange={(e) =>
          ...
          <div className="col-md-4 ">
            <div className="form-group">
              ...
              <DatePicker
                ...
                onChange={(value) =>
                  this.handleChangeFieldCustom("startExport", value)
                }
